...
\title{\bf Evaluating Space-Filling Designs for Prediction and Sequential Optimization}
...
@
\includegraphics[width=\textwidth]{pdfs/branin_fun}
\caption*{(a) 3D plot}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.4\textwidth}
...
@
\includegraphics[width=\textwidth]{pdfs/branin_contour}
...
@
\includegraphics[width=\textwidth]{pdfs/camel6_fun}
\caption*{(a) 3D plot}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.4\textwidth}
...
@
\includegraphics[width=\textwidth]{pdfs/camel6_contour}
  \caption*{(b) Contour plot}
\end{subfigure}
...
@
\includegraphics[width=\textwidth]{pdfs/goldpr_fun}
\caption*{(a) 3D plot}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.4\textwidth}
...
@
\includegraphics[width=\textwidth]{pdfs/goldpr_contour}
  \caption*{(b) Contour plot}
\end{subfigure}
...
@
\includegraphics[width=\textwidth]{pdfs/ackley2}
...
@
\includegraphics[width=\textwidth]{pdfs/ackley2zoom}
...
@
\includegraphics[width=\textwidth]{pdfs/levy_10}
...
@
\includegraphics[width=\textwidth]{pdfs/michal_m1}
...
@
\includegraphics[width=\textwidth]{pdfs/michal_m10}
...
@
\includegraphics[width=\textwidth]{pdfs/phi_p_psi}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/phi_p_cd}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/phi_p_eta}
\end{subfigure}
\vfill
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/phi_p_rho_ave}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/psi_cd}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/psi_eta}
\end{subfigure}
\vfill
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/psi_rho_ave}
%\includegraphics[scale=0.5]{pdfs/psi_rho_ave}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/cd_eta}
%\includegraphics[scale=0.5]{pdfs/cd_eta}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/cd_rho_ave}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
legend("bottomright",legend = levels(dat$design),fill = 1:5)
@
\includegraphics[width=\textwidth]{pdfs/eta_rho_ave}
\end{subfigure}
...
@
\includegraphics[width=\textwidth]{pdfs/Borehole_64x15}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Circuit}
...
@
\includegraphics[width=\textwidth]{pdfs/Circuit_64x15}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Currin}
...
@
\includegraphics[width=\textwidth]{pdfs/Currin_64x15}
\end{subfigure}
\vfill
\begin{subfigure}[b]{0.35\textwidth}
\centering
...
@
\includegraphics[width=\textwidth]{pdfs/Gfunction_64x15}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
...
@
\includegraphics[width=\textwidth]{pdfs/OakleyOhagan_64x15}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Piston}
...
@
\includegraphics[width=\textwidth]{pdfs/Piston_64x15}
\end{subfigure}
\vfill
\begin{subfigure}[b]{0.35\textwidth}
\centering
...
@
\includegraphics[width=\textwidth]{pdfs/Rosenbrock4d_64x15}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Wingweight}
...
@
\includegraphics[width=\textwidth]{pdfs/Wingweight_64x15}
\end{subfigure}
...
@
\includegraphics[width=\textwidth]{pdfs/Borehole_128x31}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Circuit}
...
@
\includegraphics[width=\textwidth]{pdfs/Circuit_128x31}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Currin}
...
@
\includegraphics[width=\textwidth]{pdfs/Currin_128x31}
\end{subfigure}
\vfill
\begin{subfigure}[b]{0.35\textwidth}
\centering
...
@
\includegraphics[width=\textwidth]{pdfs/Gfunction_128x31}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{OakleyOhagan}
...
@
\includegraphics[width=\textwidth]{pdfs/OakleyOhagan_128x31}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Piston}
...
@
\includegraphics[width=\textwidth]{pdfs/Piston_128x31}
\end{subfigure}
\vfill
\begin{subfigure}[b]{0.35\textwidth}
\centering
...
@
\includegraphics[width=\textwidth]{pdfs/Rosenbrock4d_128x31}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
\centering
\caption{Wingweight}
...
@
\includegraphics[width=\textwidth]{pdfs/Wingweight_128x31}
\end{subfigure}
...
@
\includegraphics[width=\textwidth]{pdfs/Currin_128x31_no_outlier}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
\centering
\caption{Wing Weight}
...
@
\includegraphics[width=\textwidth]{pdfs/Wingweight_128x31_no_outlier}
\end{subfigure}
...
@
\includegraphics[width=\textwidth]{pdfs/branin_lineplot}
\end{subfigure}
%
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
lineplot("camel6_20x2_ymin.txt", dir=data_dir, nstep_max = 20) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/camel6_lineplot}
\end{subfigure}
%\centering
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
lineplot("goldpr_20x2_ymin.txt", dir=data_dir, nstep_max = 20) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/goldpr_lineplot}
\end{subfigure}
\caption*{\includegraphics [scale=0.3,trim={2cm 7.3cm 0 7cm},clip]{pdfs/legend}}
...
lineplot("ackley_40x4_ymin.txt", dir=data_dir,nstep_max = 20) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/ackley4_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
\caption{4D Levy}
...
lineplot("levy_40x4_ymin.txt", dir=data_dir, nstep_max = 20) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/levy4_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
lineplot('michal_40x4_ymin.txt', dir=data_dir, nstep_max = 20) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/michal_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
\caption{6D Ackley}
...
lineplot("ackley_60x6_ymin.txt", dir=data_dir, nstep_max = 30) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/ackley6_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
\caption{6D Levy}
...
lineplot("levy_60x6_ymin.txt",dir=data_dir, nstep_max = 30) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/levy6_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
lineplot('michal_60x6_ymin.txt', dir=data_dir, nstep_max = 30) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/michal6_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
\caption{8D Ackley}
...
lineplot("ackley_80x8_ymin.txt", dir=data_dir, nstep_max = 30) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/ackley8_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
\caption{8D Levy}
...
lineplot("levy_80x8_ymin.txt", dir=data_dir, nstep_max = 30) +
 theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/levy8_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
...
lineplot('michal_80x8_ymin.txt', dir=data_dir, nstep_max = 30) +
  theme(legend.position="none")
@
\includegraphics[width=\textwidth]{pdfs/michal8_lineplot}
\end{subfigure}
\begin{subfigure}[b]{0.3\textwidth}
\centering
